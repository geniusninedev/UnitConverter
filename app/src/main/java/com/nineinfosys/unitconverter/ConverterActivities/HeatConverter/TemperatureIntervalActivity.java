...
import com.nineinfosys.unitconverter.ConverterActivityList.HeatConverter.ConversionTemperatureIntervalListActivity;
...
public class TemperatureIntervalActivity extends AppCompatActivity implements View.OnClickListener,TextWatcher {
    ...
    TemperatureIntervalConverter.ConversionResults item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // DrawableCompat.setTintList(DrawableCompat.wrap(switchChangeType.getTrackDrawable()), ColorStateList.valueOf(ContextCompat.getColor(this, R.color.colorRed)));
        ...
        listtempFirstfrom.add("Degree Celsius -°C");

        //for first time running spinner
        listFirsttempTo.add("Kelvin -K");
        listFirsttempTo.add("Degree Celsius -°C");

        // Creating adapter for spinner
        ArrayAdapter<String> Adapter = new ArrayAdapter<String>(TemperatureIntervalActivity.this, android.R.layout.simple_spinner_item, listtempFirstfrom);
        ArrayAdapter<String> AdapterTempTo = new ArrayAdapter<String>(TemperatureIntervalActivity.this, android.R.layout.simple_spinner_item, listFirsttempTo);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                switch (stringSwitchSate) {
                    ...
                    case "false":
                        ...
                        listtempfrom.add("Degree Celsius -°C");


                        //2 spinner
                        listtempTo.add("Kelvin -K");
                        listtempTo.add("Degree Celsius -°C");
                        break;
                    ...
                    case "true":
                        ...
                        listtempfrom.add("Kelvin -K");
                        listtempfrom.add("Degree Celsius -°C");
                        listtempfrom.add("Degree centigrade -°C");
                        listtempfrom.add("Degree Fahrenheit -°F");
                        listtempfrom.add("Degree Rankine -°R");
                        listtempfrom.add("Degree Reaumur -°r");


                        //second spinner
                        listtempTo.add("Kelvin -K");
                        listtempTo.add("Degree Celsius -°C");
                        listtempTo.add("Degree centigrade -°C");
                        listtempTo.add("Degree Fahrenheit -°F");
                        listtempTo.add("Degree Rankine -°R");
                        listtempTo.add("Degree Reaumur -°r");

                        break;
                }
                // Creating adapter for spinner
                ArrayAdapter<String> Adapter2 = new ArrayAdapter<String>(TemperatureIntervalActivity.this, android.R.layout.simple_spinner_item, listtempfrom);
                ArrayAdapter<String> AdapterTempTo2 = new ArrayAdapter<String>(TemperatureIntervalActivity.this, android.R.layout.simple_spinner_item, listtempTo);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_list_fullreport:
                doubleEdittextvalue = Double.parseDouble(editTextValue.getText().toString().trim());
                Intent i = new Intent(this, ConversionTemperatureIntervalListActivity.class);
    ...
    public void calcualteValue(String strSpinnerFromvalue1, String strSpinnerTovalue2, double doubleEdittextvalue1) {
        ...
        try {
            ...
            TemperatureIntervalConverter c = new TemperatureIntervalConverter(strSpinnerFromvalue1, doubleEdittextvalue1);
    ...
    private void conversion(String strSpinnerTovalue2) {
        ...
        switch (strSpinnerTovalue2) {
            case "Kelvin -K":
               editTextValueTo.setText(strkelvin);
                break;
            case "Degree Celsius -°C":
               editTextValueTo.setText(strdegreeCelsius);
                break;
            case "Degree centigrade -°C":
               editTextValueTo.setText(strdegreecentigrade);
                break;
            case "Degree Fahrenheit -°F":
               editTextValueTo.setText(strdegreeFahrenheit);
                break;
            case "Degree Rankine -°R":
               editTextValueTo.setText(strdegreeRankine);
                break;
            case "Degree Reaumur -°r":
               editTextValueTo.setText(strdegreeReaumur);
                break;
        }
